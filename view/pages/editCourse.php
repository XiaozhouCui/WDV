...
if ($_SESSION['level'] == 'Admin') { 
	...
	<div class="bigholder">
		<h1>Edit User</h1>
		<form action="../../controller/pdoUser.php"  method="post">
			<fieldset>
				...
				<input type="radio" name=role value="Student" <?php echo ($result['access_level'] == "Student" ? 'checked="checked"': ''); ?>>Student  <br><br>
			</fieldset>
			<fieldset>
